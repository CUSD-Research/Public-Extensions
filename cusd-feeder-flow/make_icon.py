#!/usr/bin/env python3
"""
Render the extension icon from icon.svg and embed it into cusd-feeder-flow.trex.

icon.svg (the origin-bar + three-ribbon "Flow" glyph) is the master asset. Tableau
...
TREX_PATH = HERE / "cusd-feeder-flow.trex"
