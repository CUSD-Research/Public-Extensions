#!/usr/bin/env python3
"""
Render the extension icon from icon.svg and embed it into cusd-pdf-print.trex.

icon.svg is the master asset: the folded-page "PDF" glyph, traced pixel by pixel
from reference/assets/tableau-icons/Grey Modern/PDF Icon.png so the button
matches the PDF icon already used on CUSD dashboards. Tableau
...
TREX_PATH = HERE / "cusd-pdf-print.trex"
